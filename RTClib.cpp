...
boolean RTC_DS1307::begin(int sdaPin, int sclPin, uint32_t frequency)
{
...
boolean RTC_PCF8523::begin(int sdaPin, int sclPin, uint32_t frequency)
{
    Wire.begin(sdaPin, sclPin, frequency);
    Wire.beginTransmission(PCF8523_ADDRESS);
    if (Wire.endTransmission() == 0)
...
boolean RTC_PCF8563::begin(int sdaPin, int sclPin, uint32_t frequency)
{
    Wire.begin(sdaPin, sclPin, frequency);
    Wire.beginTransmission(PCF8563_ADDRESS);
    if (Wire.endTransmission() == 0)
...
boolean RTC_DS3231::begin(int sdaPin, int sclPin, uint32_t frequency)
{
    Wire.begin(sdaPin, sclPin, frequency);
    Wire.beginTransmission(DS3231_ADDRESS);
    if (Wire.endTransmission() == 0)
